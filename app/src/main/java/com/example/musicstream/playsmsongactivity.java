...
public class playsmsongactivity extends AppCompatActivity {
    ...
    private SongCollectionsm songCollectionsm = new SongCollectionsm();
    private SongCollectionsm originalsongCollection = new SongCollectionsm();
    List<Song> shufflelist = Arrays.asList(songCollectionsm.songs);
    SeekBar seekBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_playsmsongactivity);
    ...
    public void displaySongBasedOnIndex() {
        Song song = songCollectionsm.getCurrentSong(currentindex);
        title = song.getTitle();
    ...
    public void playNext(View view) {
        currentindex = songCollectionsm.getNextSong(currentindex);
    ...
    public void playPrevious(View view){
        currentindex = songCollectionsm.getPrevSong(currentindex);
    ...
    public void shuffleSong(View view) {
        if (shuffleFlag) {
            ...
            songCollectionsm= new SongCollectionsm();
...

        {
            ...
            shufflelist.toArray(songCollectionsm.songs);
