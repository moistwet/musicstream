...
public class playbesongactivity extends AppCompatActivity {
    ...
    private SongCollectionbe songCollectionbe = new SongCollectionbe();
    private SongCollectionbe originalsongCollection = new SongCollectionbe();
    List<Song> shufflelist = Arrays.asList(songCollectionbe.songs);
    SeekBar seekBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_playbesongactivity);
    ...
    public void displaySongBasedOnIndex() {
        Song song = songCollectionbe.getCurrentSong(currentindex);
        title = song.getTitle();
    ...
    public void playNext(View view) {
        currentindex = songCollectionbe.getNextSong(currentindex);
    ...
    public void playPrevious(View view){
        currentindex = songCollectionbe.getPrevSong(currentindex);
    ...
    public void shuffleSong(View view) {
        if (shuffleFlag) {
            ...
            songCollectionbe= new SongCollectionbe();
...

        {
            ...
            shufflelist.toArray(songCollectionbe.songs);
