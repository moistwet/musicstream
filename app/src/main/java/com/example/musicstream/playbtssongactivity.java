...
public class playbtssongactivity extends AppCompatActivity {
    ...
    private SongCollectionbts songCollectionbts = new SongCollectionbts();
    private SongCollectionbts originalsongCollection = new SongCollectionbts();
    List<Song> shufflelist = Arrays.asList(songCollectionbts.songs);
    SeekBar seekBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_playbtssongactivity);
    ...
    public void displaySongBasedOnIndex() {
        Song song = songCollectionbts.getCurrentSong(currentindex);
        title = song.getTitle();
    ...
    public void playNext(View view) {
        currentindex = songCollectionbts.getNextSong(currentindex);
    ...
    public void playPrevious(View view){
        currentindex = songCollectionbts.getPrevSong(currentindex);
    ...
    public void shuffleSong(View view) {
        if (shuffleFlag) {
            ...
            songCollectionbts= new SongCollectionbts();
...

        {
            ...
            shufflelist.toArray(songCollectionbts.songs);
