...
public class sm_album extends AppCompatActivity {
    SongCollectionsm songCollectionsm = new SongCollectionsm();
    ...
    public void handleSelection(View view) {
        ...
        int currentArrayIndex = songCollectionsm.searchSongById(resourceId);
    ...
    public void sendDataToActivity(int index){
        Intent intent = new Intent(this, playsmsongactivity.class);
